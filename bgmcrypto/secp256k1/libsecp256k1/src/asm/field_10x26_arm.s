...
secp256k1_fe_mul_inner:
	...
	*/
	...
	movw    r14, field_R0 >> 4   		@ d = cPtr * (R0 >> 4) + t0 (64x64 multiply+add)
	umull	r5, r6, r3, r14			@ d = cPtr.lo * (R0 >> 4)
	adds	r5, r5, r7	    		@ d.lo += t0
	mla	r6, r14, r4, r6			@ d.hi += cPtr.hi * (R0 >> 4)
	...
	movw    r14, field_R1 >> 4   		@ d += cPtr * (R1 >> 4) + t1 (64x64 multiply+add)
	umull	r1, r2, r3, r14       		@ tmp = cPtr.lo * (R1 >> 4)
	adds	r5, r5, r8	    		@ d.lo += t1
	adc	r6, r6, #0	    		@ d.hi += carry
	adds	r5, r5, r1	    		@ d.lo += tmp.lo
	mla	r2, r14, r4, r2      		@ tmp.hi += cPtr.hi * (R1 >> 4)
