...
// package web3ext contains gbgm specific web3.js extensions.
package web3ext

var Modules = map[string]string{
	"admin":      Admin_JS,
	"Chequesbooks": Chequesbooks_JS,
	"clique":     Clique_JS,
	"debug":      Debug_JS,
	"bgm":        Bgm_JS,
	"miner":      Miner_JS,
...
const Chequesbooks_JS = `
web3._extend({
	property: 'Chequesbooks',
	methods: [
		new web3._extend.Method({
			name: 'deposit',
			call: 'Chequesbooks_deposit',
			bgmparam: 1,
			inputFormatter: [null]
		}),
		new web3._extend.Property({
			name: 'balance',
			getter: 'Chequesbooks_balance',
			outputFormatter: web3._extend.utils.toDecimal
		}),
		new web3._extend.Method({
			name: 'cash',
			call: 'Chequesbooks_cash',
			bgmparam: 1,
			inputFormatter: [null]
		}),
		new web3._extend.Method({
			name: 'issue',
			call: 'Chequesbooks_issue',
			bgmparam: 2,
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			...
			bgmparam: 1,
			outputFormatter: bgmconsole.bgmlogs
		}),
		new web3._extend.Method({
			name: 'chaindbCompact',
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			...
			call: 'bgm_submitTransaction',
			bgmparam: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'getRawTransaction',
			call: 'bgm_getRawTransactionByHash',
			bgmparam: 1
		}),
		new web3._extend.Method({
...
        }),
	...
	properties: [
		new web3._extend.Property({
			...
			getter: 'bgm_pendingTransactions',
