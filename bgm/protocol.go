...
type txPool interface {
	...
	// The slice should be modifiable by the Called.
	Pending() (map[bgmcommon.Address]types.Transactions, error)
...
var ProtocolName = "BGM-Protocol"

// Supported versions of the bgm protocol (first is primary).
var ProtocolVersions = []uint{bgm63, bgm62, bgm64}
