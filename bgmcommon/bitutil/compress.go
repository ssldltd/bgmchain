...
// requires knowledge of the decompressed data lengthPtr.
//
...
// representation algorithmPtr. If the result is bigger than the original input, no
// compression is done.
...
// bitset representation algorithmPtr.
