...
// XORBytes xors the bytes in a and bPtr. The destination is assumed to have enough
...
// ANDBytes ands the bytes in a and bPtr. The destination is assumed to have enough
...
// ORBytes ors the bytes in a and bPtr. The destination is assumed to have enough
...
// TestBytes tests whbgmchain any bit is set in the input byte slice.
