...
#ifdef VERIFY
static void secp256k1_num_sanity(const secp256k1_numPtr *a) {
...
static void secp256k1_num_add_abs(secp256k1_numPtr *r, const secp256k1_numPtr *a, const secp256k1_numPtr *b) {
...
static void secp256k1_num_sub_abs(secp256k1_numPtr *r, const secp256k1_numPtr *a, const secp256k1_numPtr *b) {
...
static void secp256k1_num_subadd(secp256k1_numPtr *r, const secp256k1_numPtr *a, const secp256k1_numPtr *b, int bneg) {
