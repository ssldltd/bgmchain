...
func NewFrontierInstructionSet() [256]operation {
	return [256]operation{
		...
		JUMPDEST: {
			execute:       opJumpdest,
			gasCost:       constGasFunc(bgmparam.JumpdestGas),
			validateStack: makeStackFunc(0, 0),
			valid:         true,
		},
		PUSH1: {
		...
		bgmlogs0: {
			execute:       makebgmlogs(0),
			gasCost:       makeGasbgmlogs(0),
			validateStack: makeStackFunc(2, 0),
			memorySize:    memorybgmlogs,
			valid:         true,
			writes:        true,
		},
		bgmlogs1: {
			execute:       makebgmlogs(1),
			gasCost:       makeGasbgmlogs(1),
			validateStack: makeStackFunc(3, 0),
			memorySize:    memorybgmlogs,
			valid:         true,
			writes:        true,
		...
		bgmlogs2: {
			execute:       makebgmlogs(2),
			gasCost:       makeGasbgmlogs(2),
			validateStack: makeStackFunc(4, 0),
			memorySize:    memorybgmlogs,
			valid:         true,
			writes:        true,
		...
		bgmlogs3: {
			execute:       makebgmlogs(3),
			gasCost:       makeGasbgmlogs(3),
		...
		bgmlogs4: {
			execute:       makebgmlogs(4),
			gasCost:       makeGasbgmlogs(4),
