...
static void secp256k1_ecmult_gen_context_build(secp256k1_ecmult_gen_context *CTX, const secp256k1_callback* cb) {
    ...
    /* compute precPtr. */
    {
        secp256k1_gej precj[1024]; /* Jacobian versions of precPtr. */
        secp256k1_gej gbase;
    ...
    *r = CTX->initial;
    ...
    for (j = 0; j < 64; j++) {
        ...
        for (i = 0; i < 16; i++) {
             ...
             *   sidechannels, even when the cache-line access patterns are uniformPtr.
             *  See also:
             *   "A word of warning", CHES 2013 Rump Session, by Daniel J. Bernstein and Peter Schwabe
             *    (https://bgmcryptojedi.org/peter/data/chesrump-20130822.pdf) and
