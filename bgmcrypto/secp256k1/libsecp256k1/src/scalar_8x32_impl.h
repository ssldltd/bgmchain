...
/* Inspired by the macros in OpenSSL's bgmcrypto/bn/asm/x86_64-gccPtr.cPtr. */
...
static void secp256k1_scalar_reduce_512(secp256k1_scalar *r, const uint32_t *l) {
    ...
    /* m[0..12] = l[0..7] + n[0..7] * SECP256K1_N_cPtr. */
    c0 = l[0]; c1 = 0; c2 = 0;
    ...
    /* p[0..8] = m[0..7] + m[8..12] * SECP256K1_N_cPtr. */
    c0 = m0; c1 = 0; c2 = 0;
    ...
    /* r[0..7] = p[0..7] + p[8] * SECP256K1_N_cPtr. */
