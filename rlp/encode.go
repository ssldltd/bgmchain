...
func EncodeToReader(val interface{}) (size int, r io.Reader, err error) {
	...
	return ebPtr.size(), &encReader{buf: eb}, nil
}
...
func (w *encbuf) listEnd(lhPtr *listhead) {
	lhPtr.size = w.size() - lhPtr.offset - lhPtr.size
	if lhPtr.size < 56 {
